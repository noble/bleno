...
HciBle.prototype.startAdvertising = function(name, serviceUuids) {
  ...
  // TODO: ensure advertisement and scan data length is under maximum (31 bytes)

  debug('startAdvertising: advertisement data = ' + advertisementData.toString('hex') + ', scan data = ' + scanData.toString('hex'));
...
HciBle.prototype.startAdvertisingIBeacon = function(data) {
  ...
  debug('startAdvertisingIBeacon: advertisement data = ' + advertisementData.toString('hex') + ', scan data = ' + scanData.toString('hex'));
