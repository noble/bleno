...
// Core 4.2: 7.7.65.2 LE Advertising Report Event, Event Parameters:
const ADV_IND = 0x00
...
Hci.prototype.setAdvertisingParameters = function(adv_type = ADV_IND) {
...
Hci.prototype.processCmdCompleteEvent = function(cmd, status, result) {
  ...
  if (cmd === RESET_CMD) {
    ...
    if (hciVer < 0x06) {
      ...
      this.setAdvertisingParameters(ADV_NONCONN_IND);
    }
